...
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: rgb(10, 111, 79);">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="register.php">Signup</a>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light  border-bottom" style="background-color: #B5E0FA">


        <button class="toggler" type="button" id="menu-toggle" aria-expanded="false" style="background-color: #B5E0FA">
      ...
      <nav aria-label="breadcrumb " id="bc" class="col-md-12 text-center">
            <ol class="breadcrumb bg-warning row">
            <li class="col-md-9"><h5>Hello <?php echo  $username ?>!</h5></li>
            <li class= "col-md-3"> <a href="../algo/path.php"><button type="button" class="btn btn-dark">View Transaction Path</button></a></li>
            </ol>
      </nav>
