...
<div class="offcanvas-header">
        ...
        <label for="group">Group</label>
            ...
            <?php
                    $grplist_fetched = mysqli_query($con, "SELECT * FROM groupt WHERE gadmin = '$username'");

            
            while ($row = mysqli_fetch_array($grplist_fetched)) { ?>
                ...
                <select class="form-control form-control-sm" name="member"required>
                    ...
                    <?php
                    $memberlist_fetched = mysqli_query($con, "SELECT * FROM users");

            
            while ($row = mysqli_fetch_array($memberlist_fetched)) { ?>
